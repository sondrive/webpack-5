...
/* harmony export */   "suma2": () => (/* binding */ suma2)
/* harmony export */ });
function suma2(a, b) {
  return a + b;
}
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_index_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(10);
...
const sumaExport = (__webpack_require__(1).suma);
const zmiennaExport = (__webpack_require__(1).zmienna);



console.log(sumaExport(1, 2));
console.log(zmiennaExport);
console.log((0,_sum2__WEBPACK_IMPORTED_MODULE_0__.suma2)(1, 2));
